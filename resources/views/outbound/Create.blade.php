...
<nav class="bg-gray-800 text-white shadow  px-20">
  <div class="container mx-auto px-4 py-4 flex items-center justify-between">
    ...
    <ol class="flex text-sm font-medium space-x-2 text-gray-300">
      ...
      <li class="flex items-center">
        <a href="{{ route('outbounds.list') }}"  class="hover:text-white transition-colors duration-200">Outbound     List</a>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
      </li>
...
<h1 class="text-4xl  text-center text-gray-200 dark:text-gray-100">
  Outbound Data Creation
</h1>

    <!-- Upload Form -->
    <div class="max-w-3xl mx-auto mt-20 bg-gray-800 p-6 rounded-lg shadow-lg">
    <h1 class='mb-3 text-center text-bold'>Uplode Outbound Data File</h1>
